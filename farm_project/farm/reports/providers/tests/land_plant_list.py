...
from farm.reports.providers import ReportProviderLandPlantList
...
class ReportProviderLandPlantListTest(TestCase):
    ...
    def test_generate_list(self):
        ...
        for result in results:
            ...
            self.assertIn("test_file_download_link_pac_code", result)
            self.assertIn("test_conditional_file_download_link_pac_code", result)
            self.assertIn("test_async_flow_req_link_pac_code", result)
            self.assertIn("test_conditional_async_flow_req_link_pac_code", result)
            self.assertIn("conditional_btn_example_link_plant_code", result)
