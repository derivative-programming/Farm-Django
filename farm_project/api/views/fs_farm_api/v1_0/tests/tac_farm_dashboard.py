...
class TacFarmDashboardViewSetTestCase(TestCase):
    ...
    def test_submit_success(self):
        ...
        response = self.client.get(f'/api/v1_0/tac-farm-dashboard/{self.tac.code}/', data=self.valid_request_data, format='json')
    ...
    def test_submit_failure(self):
        ...
        response = self.client.get(f'/api/v1_0/tac-farm-dashboard/{self.tac.code}/', data=self.invalid_request_data, format='json')
        self.assertEqual(response.status_code, 200)
        json_string = response.content.decode() 
        responseDict = json.loads(json_string) 
    ...
    def test_submit_failure2(self):
        response = self.client.get('/api/v1_0/tac-farm-dashboard/xxx/')
        self.assertEqual(response.status_code, 404) 

    def test_submit_failure3(self):
        response = self.client.get('/api/v1_0/tac-farm-dashboard/')
        self.assertEqual(response.status_code, 404)
        

    def test_submit_failure4(self):
        response = self.client.get(f'/api/v1_0/tac-farm-dashboard/{self.tac.code}/', data=self.invalid_request_data2, format='json')
        self.assertEqual(response.status_code, 200)
        json_string = response.content.decode() 
        responseDict = json.loads(json_string) 
        self.assertFalse(response.data['success'])
    ...
    def test_submit_failure5(self):
        response = self.client.get(f'/api/v1_0/tac-farm-dashboard/{self.tac.code}/', data=self.invalid_request_data3, format='json')
        self.assertEqual(response.status_code, 200)
        json_string = response.content.decode() 
        responseDict = json.loads(json_string) 
        self.assertFalse(response.data['success'])
    ...
    def test_init_success(self):
        response = self.client.get(f'/api/v1_0/tac-farm-dashboard/{self.tac.code}/init/')
        self.assertEqual(response.status_code, 200)
        json_string = response.content.decode() 
        responseDict = json.loads(json_string) 
    ...
    def test_init_failure(self):
        response = self.client.get('/api/v1_0/tac-farm-dashboard/xxx/init/')
        self.assertEqual(response.status_code, 404)
        
    def test_init_failure2(self):
        response = self.client.get('/api/v1_0/tac-farm-dashboard/init/')
        self.assertEqual(response.status_code, 404)
