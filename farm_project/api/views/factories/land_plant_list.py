...
from api.views.models import LandPlantListGetModelRequest
from datetime import date, datetime
from decimal import Decimal
 
class LandPlantListRequestFactory(factory.base.Factory):
    class Meta:
    ...
    somePhoneNumber:str = Faker('phone_number')    
    someEmailAddress:str = Faker('email')  
    pageNumber = 1
    itemCountPerPage = 1
